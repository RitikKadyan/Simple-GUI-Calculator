...
# Add numbers and symbols to the text field
...
# Evaluates the math expression in the text field
def evaluate_calculation():
    ...
    try:
        ...
        text_result.delete(1.0, "end")
        text_result.insert(1.0, calculation)
    # If the expression in the text field is not correct then shows as Error
    except:
        clear_field()
...
btn_mult = tk.Button(root, text="*", command=lambda: add_to_calculation("*"), width=5, font=("Ariel", 14))
